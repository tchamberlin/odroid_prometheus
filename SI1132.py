"""From: https://github.com/hardkernel/WEATHER-BOARD/blob/b029d7266b18c185e3edf70d596cef97c07c6112/python_weather/SI1132.py"""
...
class SI1132:
    def __init__(self, i2c_dev):
        ...
        param = (
            params["Si1132_PARAM_CHLIST_ENUV"]
            | params["Si1132_PARAM_CHLIST_ENALSIR"]
            | params["Si1132_PARAM_CHLIST_ENALSVIS"]
        )
        self.writeParam(params["Si1132_PARAM_CHLIST"], param)

        self.write_reg8(regs["Si1132_REG_INTCFG"], regs["Si1132_REG_INTCFG_INTOE"])
        self.write_reg8(
            regs["Si1132_REG_IRQEN"], regs["Si1132_REG_IRQEN_ALSEVERYSAMPLE"]
        )

        self.writeParam(
            params["Si1132_PARAM_ALSIRADCMUX"], params["Si1132_PARAM_ADCMUX_SMALLIR"]
        )
        time.sleep(0.01)
        self.writeParam(params["Si1132_PARAM_ALSIRADCGAIN"], 0)
        time.sleep(0.01)
        self.writeParam(
            params["Si1132_PARAM_ALSIRADCCOUNTER"],
            params["Si1132_PARAM_ADCCOUNTER_511CLK"],
        )
        self.writeParam(
            params["Si1132_PARAM_ALSIRADCMISC"],
            params["Si1132_PARAM_ALSIRADCMISC_RANGE"],
        )
        time.sleep(0.01)
        self.writeParam(params["Si1132_PARAM_ALSIRADCGAIN"], 0)
        time.sleep(0.01)
        ...
        self.writeParam(
            params["Si1132_PARAM_ALSVISADCMISC"],
            params["Si1132_PARAM_ALSVISADCMISC_VISRANGE"],
        )
        time.sleep(0.01)
